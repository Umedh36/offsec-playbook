...
| <p><strong>Databases</strong><br><br><br><br>(<code>.sql</code>, <code>.db</code>, <code>.</code><em><code>db</code>, <code>.db</code></em>)</p>                               | Databases stored locally that may contain user tables or application credentials.                     | <p><strong>Find database files:</strong><br><br><br><br><code>for l in $(echo ".sql .db .</code><em><code>db .db</code></em><code>");do echo -e "\nDB File extension: " $l; find / -name *$l 2>/dev/null | grep -v "doc|lib|headers|share|man";done</code></p>                                                                                                                                                                                                                                   |
| <p><strong>Notes / Text Files</strong><br><br><br><br>(<code>.txt</code> or no extension)</p>                                                                                  | Documentation, setup notes, or lists of credentials left by administrators/users.                     | <p><strong>Find text files or extensionless files in home directories:</strong><br><br><br><br><code>find /home/* -type f -name "</code><em><code>.txt" -o ! -name "</code></em><code>.*"</code></p>                                                                                                                                                                                                                                                                                             |
...
| <p><strong>History Files</strong><br><br><br><br><code>.bash_history</code>, <code>.bashrc</code>, <code>.bash_profile</code></p>                                              | Records of user commands (which may accidentally include typed passwords) and environment setups.     | <p><strong>View last 5 lines of all user histories:</strong><br><br><br><br><code>tail -n5 /home/</code><em><code>/.bash</code></em></p>                                                                                                                                                                                                                                                                                                                                                         |
